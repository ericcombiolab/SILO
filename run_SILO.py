...
parser.add_argument("--seed_score_thres",type=float,default=None,help="the threshold score of the seed (a window that contain the rare variant)")
parser.add_argument("--negative_thres",type=float,default=-0.4,help="the threshold of window common scores for negative count and negative ratio")
